<%-- 
    Document   : index.jsp
    Created on : Jul 1, 2020, 10:03:51 AM
    Author     : hp
--%>
...
<html>
    <head>
        <jsp:include page='views/layouts/head.jsp'></jsp:include>
    </head>
    <body>
                        ...
                        <div class="col-md-6">
                                <div class="card">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <a href="${pageContext.request.contextPath}/detail" class="btn btn-sm btn-primary">Selengkapnya</a>
                                        </div>
                                    </div>
                        </div>
                        <div class="col-md-6">
